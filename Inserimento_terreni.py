...
background_image = tk.PhotoImage(file='img/terreno.png')
...
def send_info(listTerrain, listMq):
    ...
    text_output = tk.Label(window, text=text, fg="green", font=("Times New Roman", 16)).place(x=240, y=340)
    if aux == False:
...
def close_window():
    window.destroy()
close_button = tk.Button(text="Vai alle colture selezionate", fg="#282828", bg="#7EA87E", font="Georgia",
                        width=61, command=close_window).place(x=20, y=375)
...
if __name__ == '__main__':
    ...
    background_image = tk.PhotoImage(file='img/colture.png')
    ...
    for x, y in dictPlant.items():
        if j == 0:
            ...
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=50)
        elif j == 1:
            ...
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=90)
        elif j == 2:
            ...
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=130)
        elif j == 3:
            ...
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=170)
        elif j == 4:
            labelDim = tk.Label(text=x + ":", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=120, y=210)
            textDim = tk.Label(text=y, fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=270, y=210)
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=210)
        elif j == 5:
            labelDim = tk.Label(text=x + ":", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=120, y=250)
            textDim = tk.Label(text=y, fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=270, y=250)
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=250)
        elif j == 6:
            labelDim = tk.Label(text=x + ":", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=120, y=290)
            textDim = tk.Label(text=y, fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=270, y=290)
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=290)
        elif j == 7:
            labelDim = tk.Label(text=x + ":", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=120, y=330)
            textDim = tk.Label(text=y, fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=270, y=330)
            textDim = tk.Label(text="m²", fg="#282828", bg="#67BD66", font=("Georgia", 14)).place(x=350, y=330)
        j += 1
    popUp.mainloop()
    marketplace.gen_kinds(dictPlant)
    marketplace.gen_Bags()
    print("Colture disponibili sul mercato: ")
    print("{:<12} {:<20} {:<10} {:<10}".format('Varietà', 'Incassi previsti', 'Costi', 'Area coltivata in m²'))
    print("-" * 68)
